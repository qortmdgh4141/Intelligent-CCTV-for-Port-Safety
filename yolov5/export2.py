...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default= 'data/dog_dataset.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default= 'weights/best_300.pt', help='model.pt path(s)')
